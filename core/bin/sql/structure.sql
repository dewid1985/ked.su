...
-- object: users.operations | type: TABLE --
-- DROP TABLE users.operations;
CREATE TABLE users.operations(
	id serial,
	name varchar(32),
...
-- ddl-end --
-- object: users.role_operation | type: TABLE --
-- DROP TABLE users.role_operation;
CREATE TABLE users.role_operation(
	id serial,
	role_id bigint,
	operation_id bigint,
	CONSTRAINT pk__role_operation PRIMARY KEY (id)

);
-- ddl-end --
-- object: users.module | type: TABLE --
-- DROP TABLE users.module;
CREATE TABLE users.module(
	id serial,
	name varchar(256),
	description varchar(32),
	CONSTRAINT pk__module PRIMARY KEY (id)

);
-- ddl-end --
-- object: users.role_group | type: TABLE --
-- DROP TABLE users.role_group;
CREATE TABLE users.role_group(
	id serial,
	name varchar(32),
	description varchar(256),
	CONSTRAINT pk__role_type PRIMARY KEY (id)

);
-- ddl-end --
-- object: users.user_role | type: TABLE --
-- DROP TABLE users.user_role;
CREATE TABLE users.user_role(
	id serial,
	role_id bigint,
	user_id bigint,
	CONSTRAINT pk__user_role PRIMARY KEY (id)
...
-- object: fk__operation_module | type: CONSTRAINT --
-- ALTER TABLE users.operations DROP CONSTRAINT fk__operation_module;
ALTER TABLE users.operations ADD CONSTRAINT fk__operation_module FOREIGN KEY (module_id)
REFERENCES users.module (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
-- object: fk__role_role_group | type: CONSTRAINT --
-- ALTER TABLE users.role DROP CONSTRAINT fk__role_role_group;
ALTER TABLE users.role ADD CONSTRAINT fk__role_role_group FOREIGN KEY (role_group_id)
REFERENCES users.role_group (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --


-- object: fk__role_operation_role | type: CONSTRAINT --
-- ALTER TABLE users.role_operation DROP CONSTRAINT fk__role_operation_role;
ALTER TABLE users.role_operation ADD CONSTRAINT fk__role_operation_role FOREIGN KEY (role_id)
REFERENCES users.role (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --


-- object: fk_role_operation_operation | type: CONSTRAINT --
-- ALTER TABLE users.role_operation DROP CONSTRAINT fk_role_operation_operation;
ALTER TABLE users.role_operation ADD CONSTRAINT fk_role_operation_operation FOREIGN KEY (operation_id)
REFERENCES users.operations (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --


-- object: fk__user_role_user | type: CONSTRAINT --
-- ALTER TABLE users.user_role DROP CONSTRAINT fk__user_role_user;
ALTER TABLE users.user_role ADD CONSTRAINT fk__user_role_user FOREIGN KEY (user_id)
REFERENCES users.user (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --


-- object: fk__user_role_role | type: CONSTRAINT --
-- ALTER TABLE users.user_role DROP CONSTRAINT fk__user_role_role;
ALTER TABLE users.user_role ADD CONSTRAINT fk__user_role_role FOREIGN KEY (role_id)
REFERENCES users.role (id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
