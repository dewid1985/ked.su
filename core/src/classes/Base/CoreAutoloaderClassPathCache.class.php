...
class CoreAutoloaderClassPathCache implements AutoloaderRecachable, AutoloaderWithNamespace
{
    ...
    public function autoload($className, $recache = false)
    {
        ...
        if ($fileName = $this->getFileName($className)) {
            ...
            $this->includeFile(PATH_CORE_BASE.str_replace('\\' , '/' , $className) . '.class.php');
        }
    }
