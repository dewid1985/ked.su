 ...
 * Time: 17:07
 */
abstract class CoreBasicMethodMappedController extends MethodMappedController
{
    /**
     * @var ViewResolver
     */
    ...
    public function badRequest()
    {
        ...
        return ModelAndView::create()->setView($this->getView('400'));
    }
    ...
    public function forbidden()
    {
        ...
        return ModelAndView::create()->setView($this->getView('403'));
    }
    ...
    public function notFound()
    {
        ...
        return ModelAndView::create()->setView($this->getView('404'));
    }
    ...
    protected function internalError(Model $model)
    {
        ...
        return ModelAndView::create()->setModel($model)->setView($this->getView('500'));
    }
    ...
    {
        return $this->getViewResolver()->resolveViewName($viewName);
    }
